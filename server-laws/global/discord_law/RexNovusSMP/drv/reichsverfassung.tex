...
\begin{pg}
    \item Das Deutsche Reich ist eine freie und unabhängige Nation unter der Hand und Schirmherrschaft Seiner Majestät des Kaisers und somit der Deutschen Kaiserkrone zur Treue verpflichtet.
...
\begin{pg}
    ...
    \item Er ist die höchste Reichsgewalt und verfügt über absolute und uneingeschränkte Entscheidungsvollmachten.
    ...
    \item Der Begriff des Kaisers ist synonym mit dem Begriff des Deutschen Kaiserreichs, des Staates und aller weiteren Synonyme jener Begriffe.
    \item Allein der Kaiser verfügt über das Recht, Personen zu begnadigen.
\end{pg}

\subsection{Die Kaiserin}
\begin{enumerate}[(1)]
