...
\begin{enumerate}[(1)]
	\item If a person is proven to have committed crimes against the written constitution of a nation, an application for an arrest warrant can be submitted to the legal department of the server.
	\item It must be clearly demonstrated to the legal department that and how a crime has been committed by the respective person.
	\item If the legal department deems an arrest warrant sufficiently justified, it must be checked where the person in question was located at the time the warrant was applied for.
	...
	\item If the person was in domestic territory or extradition was granted, it will be decided by random procedure whether the arrest was successful.
