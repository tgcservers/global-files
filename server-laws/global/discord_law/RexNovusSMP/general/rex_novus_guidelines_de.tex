...
\subsection{Fraktionen}\label{factions}
\begin{enumerate}[(1)]
	...
	\item Aufgrund der Tätigkeit und Aufgaben der Moderation ist diese jederzeit berechtigt, in die Kanäle einzusehen, um Verstöße gegen die geltenden Richtlinien erkennen zu können.
    ...
    \item Die Teilnahme am Server erfordert die Gründung oder den Beitritt zu einer, von der Administration genehmigten Fraktion\footnote{Abs. 7, 8: Faction Establishment Act vom 20. Februar 2024}.
    ...
    \end{enumerate}
	\item Der Akt der Fraktionsgründung und das Anrecht auf dessen Fortführung wird als Fraktionserklärung bezeichnet.
\end{enumerate}

\subsection{Nichtigkeit der Fraktionserklärung}
Eine Fraktionserklärung gemäß \ref{factions} Abs. 9 ist nichtig, sofern die Fraktion
\begin{enumerate}
	\item Eines der Kriterien aus \ref{factions} Abs. 8 verliert und sich nicht in der Lage befindet, die Gesamtheit der Kriterien innerhalb von zwei Monaten zurückzuerlangen.\footnote{Faction Establishment Act vom 20. Februar 2024}
	\item Mindestens einen Monat ohne Nennung eines verständlichen und nachvollziehbaren Grundes nicht nennenswert aktiv war.\footnote{Nr. 2, 3: Faction Establishment Act Amendment VI vom 17. Juli 2024}
	\item Die Serverbestimmungen nicht einhält oder sich direkten Anordnungen des Teams widersetzt.
\end{enumerate}
...
\subsection{Nachfolgeansprüche und Revolutionen}\footnote{Faction Establishment Act Amendment vom 26. Februar 2024}
\begin{enumerate}[(1)]
	\item Das Serverrecht legt keine Nachfolgeregelungen fest und bewertet nicht die Legitimität eines Nachfolgeanspruchs.
...
\subsection{Intervention des Serverrechts in Hinsicht auf Fraktionsregelsätze und -verfassungen}
\begin{enumerate}[(1)]
...
\subsection{Schutz der Fraktionsintegrität}
\begin{enumerate}[(1)]
...
\begin{enumerate}[(1)]
    ...
    \item Man darf während des Krieges keine Unsichtbarkeitstränke, -effekte oder ähnliches nutzen.\footnote{War Regulatory Act Amendment V vom 10. Juli 2024}
\end{enumerate}
