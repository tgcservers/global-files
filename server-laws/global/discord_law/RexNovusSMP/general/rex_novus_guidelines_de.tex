...
\begin{enumerate}[(1)]
	...
	\item Befand sich die Person im Inland, der Außenwelt oder wurde der Auslieferung zugestimmt, so wird per Zufallsverfahren entschieden, ob die Haft erfolgreich verlief.
