...
\begin{enumerate}[(1)]
    ...
    \item Die Rechtsprechung erfolgt gemäß den Bestimmungen aus Absatz 3.
...
\begin{enumerate}[(1)]
    ...
    \item Als Beklagte wird die Partei bezeichnet, die Gegenstand der Vorwürfe sind.
...
\begin{enumerate}[(1)]
    ...
    \item Der Strafsatz muss sich nach der Schwere der Tat und der vergangenen Straffälligkeit des Täters richten. Hierbei darf der Strafsatz nicht die gesetlichen Vorgaben überschreiten oder unterschreiten und auch nicht auf Grundlage der Anzahl der Verstöße aufsummiert werden.
...
\begin{enumerate}[(1)]
    \item Der Aufgabenbereich des Internationalen Verfassungsgerichts umfasst die Entgegennahme und Bearbeitung von Beschwerden bezüglich der Abkommen und nationaler Verfassungen der Vertragsparteien, sowie von Delikten, die im Konflikt mit dem Abkommen von Berlin stehen.
...
\begin{enumerate}[(1)]
    \item Entscheidet der Internationale Strafgerichtshof, dass es sich bei einem rechtlichen Ausnahmefall um eine Straftat handeln müsste, so muss dies umgehend in die Berliner Gesetze aufgenommen werden und sofern nach Ermessen der Richterschaft ein Bewusstsein des Verstoßes gegen moralische Normen durch die Beklagte vorliegen sollte, der Strafe entsprechend geurteilt werden.
